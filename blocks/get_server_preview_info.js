    ...
    code: function(cache) {
        ...
        switch(server_preview_info) {
            ...
            case 5:
                ...
                break;
            case 6:
                result = Array.from(server_preview.emojis.values());
                break;
            case 7:
                result = server_preview.features.map(a => a.replace(/_/g, " ").replace(/\w\S*/g, a => a[0].toUpperCase() + a.substring(1).toLowerCase()));
                break;
            case 8:
